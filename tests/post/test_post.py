...
#     # post 객체 확인
#     assert response_json["reveal"] == test_CreatePostInput["reveal"]
#     assert response_json["title"] == test_CreatePostInput["title"]
#     assert response_json["content"] == test_CreatePostInput["content"]
#     assert response_json["photoId"] == test_CreatePostInput["photoId"]
#     assert response_json["createTime"] == test_CreatePostInput["createTime"]
#     assert response_json["hashList"] == test_CreatePostInput["hashList"]
